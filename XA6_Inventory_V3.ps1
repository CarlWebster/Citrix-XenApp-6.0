...
.DESCRIPTION
	...
	Creates a Word document named after the XenApp 6 farm.
...
.EXAMPLE
	PS C:\PSScript > .\XA6_Inventory_V3.ps1
...
.EXAMPLE
	PS C:\PSScript > .\XA6_Inventory_V3.ps1 -verbose
...
.EXAMPLE
	PS C:\PSScript .\XA6_Inventory_V3.ps1 -CompanyName "Carl Webster Consulting" -CoverPage "Mod" -UserName "Carl Webster"
...
.EXAMPLE
	PS C:\PSScript .\XA6_Inventory_V3.ps1 -CN "Carl Webster Consulting" -CP "Mod" -UN "Carl Webster"
...
Else 
{
	...
	$Title="XenApp 6 Farm Inventory Report"
	$filename="$($pwd.path)\XenApp 6 Farm Inventory.docx"
